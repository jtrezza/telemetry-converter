...
export class LapParser extends Parser {
  constructor() {
    super();
    this.endianess("little")
      ...
      .floatle("m_lapDistance") // Distance vehicle is around current lap in metres – could
      // be negative if line hasn’t been crossed yet
      .floatle("m_totalDistance") // Total distance travelled in session in metres – could
      // be negative if line hasn’t been crossed yet
...
export default class PacketLapParser extends Parser {
  constructor() {
    super();
    this.endianess("little")
      .nest("m_header", {
