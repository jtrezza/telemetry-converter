...
export class CarStatusParser extends Parser {
  constructor() {
    ...
    this.uint8('m_tractionControl') // 0 (off) - 2 (high)
      ...
      .floatle('m_enginePowerICE') // ERS energy store in Joules
      .floatle('m_enginePowerMGUK') // ERS energy store in Joules
      ...
      .uint8('m_networkPaused'); // ERS energy deployed this lap
  }
}
